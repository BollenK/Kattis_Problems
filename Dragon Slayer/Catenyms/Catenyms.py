...
if __name__ == "__main__":
    ...
    #     for first in ["a", "b", "c", "d", "e", "f","g", "h", "i", "j", "k", "l","m", "n", "o", "p", "q", "r","s", "t", "u", "v", "w", "x","y", "z","appel", "aard", "popo", "geit"]:
    #         for second in ["a", "b", "c", "d", "e", "f","g", "h", "i", "j", "k", "l","m", "n", "o", "p", "q", "r","s", "t", "u", "v", "w", "x","y", "z", "dodo", "appel", "bobod","aard", "popo", "geit"]:
    #             file.write(first+"\n")
